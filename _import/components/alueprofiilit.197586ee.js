...
// datat
export const df_alueprofiilit = await FileAttachment("../../data/df_alueprofiilit.json", import.meta.url).json("typed");
export const indicator_list = await FileAttachment("../../data/df_indicator_list.json", import.meta.url).json("typed");
const df_region = await FileAttachment("../../data/df_region.json", import.meta.url).json("typed");
